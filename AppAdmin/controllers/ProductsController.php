 ...
 * @version   SVN: $Id: ProductsController.php 30 2011-01-06 21:58:02Z tmu $
 */
...
class KreditAdmin_ProductsController extends KreditCore_Controller_AdminAbstract
{
    ...
    public function indexAction()
    {
        ...
        $modelApplications = new \Credit\Core\Model\Produkte();
        ...
        array $applications = array())
    {
        ...
        foreach ($applications as $key => $row) {
            ...
            $institutModel = new \Credit\Core\Model\Institute();
