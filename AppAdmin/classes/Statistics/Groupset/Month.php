<?php
/**
 * Klasse zum Gruppieren der Statistik nach Monaten
 *
 * PHP version 5
 *
 ...
 * @version   SVN: $Id: Month.php 30 2011-01-06 21:58:02Z tmu $
 */
    ...
    implements KreditAdmin_Class_Statistics_GroupsetInterface
{
    ...
    public function getTimespanExpression($tableAlias = 'se')
    {
        ...
        return new \Zend\Db\Expr(
            'DATE_FORMAT(' . $field . ", '%Y-%m') as `timespan`"
        );
    }
    ...
    {
        $dateStart->setDay(1)->setHour(0)->setMinute(0);
        $dateEnd->setDay(1);
        $dateEnd->addMonth(1)->subDay(1)->setHour(23)->setMinute(59);
    }
