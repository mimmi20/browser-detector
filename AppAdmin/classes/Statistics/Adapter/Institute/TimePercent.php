 ...
 * @version   SVN: $Id: TimePercent.php 30 2011-01-06 21:58:02Z tmu $
 */
 ...
 * @copyright 2007-2010 Unister GmbH
 */
class KreditAdmin_Class_Statistics_Adapter_Institute_TimePercent
    extends KreditAdmin_Class_Statistics_Adapter_InstituteAbstract
{
    ...
    {
        $expression = 'IF(SUM(`se`.`anzahl`)=0,0,IFNULL((SUM(`se`.`lz`)/'
