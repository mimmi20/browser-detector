<?php
/**
 * Klasse zum Erstellen der Statistik für den Browser Safari
 *
 * PHP version 5
 *
 ...
 * @version   SVN: $Id: Safari.php 30 2011-01-06 21:58:02Z tmu $
 */
 ...
 * @copyright 2007-2010 Unister GmbH
 */
class KreditAdmin_Class_Statistics_Adapter_Agent_Safari
    extends KreditAdmin_Class_Statistics_Adapter_Agent_BrowserAbstract
{
    ...
    {
        $where = "(`b`.`Browser` = 'Safari' OR
                   `b`.`Browser` = 'Mobile Safari')";
