...
return [
    'test-00136-01704' => [
        'ua'         => 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2877.0 Safari/537.36',
        'properties' => [
            'Browser_Name'            => 'Chrome',
    ...
    'test-00136-01719' => [
        'ua'         => 'Mozilla/5.0 (Windows; U; WinNT4.0; de-AT; rv:1.3.1) Gecko/20030425',
        'properties' => [
    ...
    'test-00136-01721' => [
        'ua'         => 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.12) Gecko/20050929 Galeon/1.3.21',
        'properties' => [
            'Browser_Name'            => 'Galeon',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01722' => [
        'ua'         => 'Mozilla/5.0 (compatible; Konqueror/3.0-rc6; i686 Linux; 20020614)',
        'properties' => [
    ...
    'test-00136-01723' => [
        'ua'         => 'Links (0.96; Linux 2.4.20-18.7 i586)',
        'properties' => [
            'Browser_Name'            => 'Links',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01725' => [
        'ua'         => 'Mozilla/5.0 (compatible; Konqueror/3.1; i686 Linux; 20021106)',
        'properties' => [
            'Browser_Name'            => 'Konqueror',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01728' => [
        'ua'         => 'Mozilla/5.0 (Android; Linux arm7l; rv:2.1.1) Gecko/20110415 Firefox/4.0.2pre Fennec/4.0.1',
        'properties' => [
            'Browser_Name'            => 'Fennec',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01730' => [
        'ua'         => 'Mozilla/5.0 (Windows NT 5.2; rv:7.0a1) Gecko/20110602 SeaMonkey/2.2a1pre',
        'properties' => [
    ...
    'test-00136-01732' => [
        'ua'         => 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-US; rv:1.8.0.7) Gecko/20060911 Camino/1.0.3',
        'properties' => [
            'Browser_Name'            => 'Camino',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01735' => [
        'ua'         => 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.3) Gecko/20070310 Iceweasel/2.0.0.3 (Debian-2.0.0.3-2)',
        'properties' => [
    ...
    'test-00136-01744' => [
        'ua'         => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/602.2.11 (KHTML, like Gecko)',
        'properties' => [
            'Browser_Name'            => 'Default Browser',
            'Browser_Type'            => 'unknown',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01745' => [
        'ua'         => 'Safari/12602.2.11 CFNetwork/807.1.2 Darwin/16.1.0 (x86_64)',
        'properties' => [
            'Browser_Name'            => 'Default Browser',
            'Browser_Type'            => 'unknown',
            'Browser_Bits'            => 64,
    ...
    'test-00136-01746' => [
        'ua'         => 'Mozilla/5.0 CommonCrawler Node JWJEIXIKXSVSL2Q6EU5WNDYM36ZF22JS7LS6TMLFSIZABHGZRPOVQZROYJ2XG6N.J.MREP7QPGB4TEL7ENRTZGO7HWF2PXFUGSRDY3UVEQXC2VKTZF.cdn0.common.crawl.zone',
        'properties' => [
    ...
    'test-00136-01750' => [
        'ua'         => 'Dalvik/1.6.0 (Linux; U; Android 4.4.2; K1_turbo Build/KOT49H)',
        'properties' => [
            'Browser_Name'            => 'Dalvik',
    ...
    'test-00136-01754' => [
        'ua'         => 'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Win64; x64; Trident/6.0; tb-gmx/2.6.9; (gmx/1.4.0.0))',
        'properties' => [
    ...
    'test-00136-01755' => [
        'ua'         => 'Mozilla/4.0 (compatible; GoogleToolbar 7.5.7619.1252; Windows 6.1; MSIE 9.11.9600.18449)',
        'properties' => [
            'Browser_Name'            => 'Internet Explorer',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01760' => [
        'ua'         => 'Mozilla/5.0 (X11; Linux x86_64) Cobalt/4.11749-devel (unlike Gecko) Starboard/1',
        'properties' => [
            'Browser_Name'            => 'Default Browser',
            'Browser_Type'            => 'unknown',
            'Browser_Bits'            => 64,
    ...
    'test-00136-01783' => [
        'ua'         => 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G920F Build/MMB29K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.122 Mobile Safari/537.36 Vivaldi/1.4.589.29',
        'properties' => [
            'Browser_Name'            => 'Chrome',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01786' => [
        'ua'         => 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729; AskTbTKR/5.8.0.12304)',
        'properties' => [
            'Browser_Name'            => 'Internet Explorer',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
    ...
    'test-00136-01796' => [
        'ua'         => 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 1.0.3705; .NET CLR 1.1.4322; Media Center PC 4.0; .NET CLR 2.0.50727; ZangoToolbar 4.8.3; .NET CLR 3.0.04506.30)',
        'properties' => [
            'Browser_Name'            => 'Internet Explorer',
            'Browser_Type'            => 'Browser',
            'Browser_Bits'            => 32,
