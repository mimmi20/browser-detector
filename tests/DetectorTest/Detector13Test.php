...
final class Detector13Test extends TestCase
{
    /**
     * @throws Exception
     ...
     */
    public function testGetBrowserWithoutCacheButWithClientCode23(): void
    {
        $hash                     = 'test-hash';
        $headerValue              = 'abc';
        ...
        $platformFromDevice       = 'windows';
        $deviceCodeForLoader      = 'unknown=windows desktop';
     ...
     * @throws UnexpectedValueException
     */
    public function testGetBrowserWithoutCacheButWithClientCode24(): void
    {
        $hash                     = 'test-hash';
        $headerValue              = 'abc';
        $headers                  = ['xyz' => $headerValue];
        ...
        $exception = new UnexpectedValueException('not expected');
