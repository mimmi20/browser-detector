...
final class Useragent8Test extends TestCase
{
    /**
     ...
     */
    public function testDataWithoutVersions20(): void
    {
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions21(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silk Build/iLA_Silk)';
        $deviceKey   = 'ila=ila silk';
        $platformKey = 'test-platform-key';
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions22(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silk Build/iLA_Silk)';
        $deviceKey   = 'ila=ila silk';
        $platformKey = 'test-platform-key';
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions23(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silk Build/iLA_Silk)';
        $deviceKey   = 'ila=ila silk';
        $platformKey = 'test-platform-key';
