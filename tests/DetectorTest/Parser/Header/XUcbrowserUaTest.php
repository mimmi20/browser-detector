...
final class XUcbrowserUaTest extends TestCase
{
    ...
    {
        return [
            ['dv(iPh4,1);pr(UCBrowser/10.2.0.517);ov(7_1_2);ss(320x416);bt(UC);pm(0);bv(0);nm(0);im(0);nt(1);', true, 'apple=apple iphone 4,1', true, 'ucbrowser', true, '10.2.0.517', false, null, true, '7.1.2', false, null, false, null],
