...
final class Useragent11Test extends TestCase
{
    /**
     ...
     */
    public function testDataWithoutVersions30(): void
    {
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions31(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silkx Build/iLA_Silk)';
        $platformKey = 'test-platform-key';
        $clientKey   = 'test-client-key';
        $engineKey   = 'test-engine-key';
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions32(): void
    {
        $ua          = 'UCWEB/2.0 (MIDP-2.0; Adr 4.4.2; PTM-Z-mini) U2/1.0.0 UCBrowser/9.2.0.419 U2/1.0.0 Mobile';
        $platformKey = 'test-platform-key';
        $clientKey   = 'test-client-key';
        $engineKey   = 'test-engine-key';
        ...
        $deviceCodeHelper
            ...
            ->method('getDeviceCode')
            ->with('ptm-z-mini')
            ->willReturn('tecno=tecno ptm-z-mini');
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions33(): void
    {
        $ua          = 'UCWEB/2.0 (Linux; Adr 4.4.2; PTM-Z-mini) U2/1.0.0 UCBrowser/9.2.0.419 U2/1.0.0 Mobile';
        $platformKey = 'test-platform-key';
        $clientKey   = 'test-client-key';
        $engineKey   = 'test-engine-key';
