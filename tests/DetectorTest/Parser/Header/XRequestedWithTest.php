...
final class XRequestedWithTest extends TestCase
{
    ...
    public static function providerUa(): array
    {
        return [
            ...
            ['com.fsecure.ms.cyfrowy', true, 'ochrona-internetu-cp', true, null, false, Os::unknown],
            ['com.fsecure.ms.plus', true, 'ochrona-internetu', true, null, false, Os::unknown],
            ['com.fsecure.ms.play.sa', true, 'ochrona-internetu', true, null, false, Os::unknown],
            ['com.fsecure.ms.emil', true, 'bezpieczny-internet', true, null, false, Os::unknown],
            ['com.fsecure.ms.yousee', true, 'yousee-sikkerhedspakke', true, null, false, Os::unknown],
            ['com.fsecure.ms.tmobile_nl', true, 'overal-veilig-online', true, null, false, Os::unknown],
            ['it.telecomitalia.timprotect', true, 'tim-navigazione-sicura', true, null, false, Os::unknown],
            ['com.fsecure.ms.stofa3', true, 'norlys-sikkerhedspakke', true, null, false, Os::unknown],
            ['com.fsecure.ms.elisa.yritystietoturva', true, 'elisa-yritystietoturva', true, null, false, Os::unknown],
            ['com.fsecure.ms.a1austria', true, 'a1-sicherheit', true, null, false, Os::unknown],
            ['com.fsecure.ms.cosmote', true, 'cosmote-total-security', true, null, false, Os::unknown],
            ['com.fsecure.ms.nextgentel2', true, 'nextgentel-total-sikkerhet', true, null, false, Os::unknown],
            ['com.fsecure.ms.fortum', true, 'fortum-safe', true, null, false, Os::unknown],
            ['com.fsecure.ms.monaco', true, 'monaco-care-safety', true, null, false, Os::unknown],
            ['com.fsecure.ms.comhem', true, 'tele2-säker', true, null, false, Os::unknown],
            ['com.fsecure.ms.sunrise', true, 'sunrise-protect', true, null, false, Os::unknown],
