...
final class XRequestedWithTest extends TestCase
{
    ...
    public static function providerUa(): array
    {
        return [
            ...
            ['mark.viab', true, 'via-browser', true, null, false, Os::unknown],
            ['mark.viah', true, 'via-browser', true, null, false, Os::unknown],
            ...
            ['de.baumann.browser1', true, 'foss-browser', true, null, false, Os::unknown],
            ...
            ['com.clariobrowser.clario', true, 'clario-browser', true, null, false, Os::unknown],
            ['com.ltd.ifbrowser', true, 'if-browser', true, null, false, Os::unknown],
            ['com.ddu.browser.oversea', true, 'ddu-browser', true, null, false, Os::unknown],
            ['com.dajiu.stay', true, 'stay-browser', true, null, false, Os::unknown],
            ['com.easy.ask.browser', true, 'ask-browser', true, null, false, Os::unknown],
            ['com.iberapps.cleartvwebbrowser', true, 'clear-tv-web-browser', true, null, false, Os::unknown],
            ['com.vcbrowser.mini.pro', true, 'vc-browser-mini-pro', true, null, false, Os::unknown],
            ['com.web.nova.browser', true, 'nova-browser', true, null, false, Os::unknown],
            ['com.saigopal.browser', true, 'black-browser', true, null, false, Os::unknown],
            ['com.browsesafe.android', true, 'browse-safe', true, null, false, Os::unknown],
            ['anonyv.navegaseguro', true, 'anonyv-browser', true, null, false, Os::unknown],
            ['com.snapbrowser.app', true, 'snap-browser', true, null, false, Os::unknown],
            ['com.enzo.paulo', true, 'seekee', true, null, false, Os::unknown],
            ['com.enzo.browser', true, 'seekee', true, null, false, Os::unknown],
            ['com.netsky.tincat', true, 'tincat-browser', true, null, false, Os::unknown],
            ['com.cloaktp.browser', true, 'cloak-private-browser', true, null, false, Os::unknown],
