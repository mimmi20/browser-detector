...
final class Useragent5Test extends TestCase
{
     ...
     */
    public function testDataWithoutVersions6(): void
    {
        $ua          = 'Mozilla/5.0 (Linux; Android 14; RMX3741 Build/UKQ1.231003.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/12.140.205 Mobile Safari/537.36';
        $deviceKey   = 'realme=realme rmx3741';
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions7(): void
    {
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions8(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silk Build/iLA_Silk)';
        $deviceKey   = 'ila=ila silk';
        $platformKey = 'test-platform-key';
     ...
     * @phpcs:disable SlevomatCodingStandard.Functions.FunctionLength.FunctionLength
     */
    public function testDataWithoutVersions9(): void
    {
        $ua          = 'Dalvik/2.1.0 (Linux; Android 8.1.0; iLA_Silk Build/iLA_Silk)';
        $deviceKey   = 'ila=ila silk';
        $platformKey = 'test-platform-key';
