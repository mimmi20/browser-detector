...
#[CoversClass(className: ChromeOs::class)]
final class ChromeOsTest extends TestCase
{
    ...
    {
        $chromeOs = new ChromeOs(new VersionBuilder());

        $detectedVersion = $chromeOs->detectVersion($useragent);
    ...
    public function testDetectVersionFail(): void
    {
        ...
        $chromeOs = new ChromeOs($versionBuilder);

        $detectedVersion = $chromeOs->detectVersion(
            'Mozilla/5.0 (X11; CrOS aarch64 11021.19.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.22 Safari/537.36',
        );
