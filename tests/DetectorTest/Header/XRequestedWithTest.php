...
final class XRequestedWithTest extends TestCase
{
    ...
    public static function providerUa(): array
    {
        return [
            ...
            ['com.morrisxar.nav88', true, 'office-browser'],
            ['epson.print', true, 'epson-iprint'],
            ['miada.tv.webbrowser', true, 'internet-web-browser'],
            ['threads.thor', true, 'thor-browser'],
            ['com.opera.browser', true, 'opera'],
            ['com.opera.browser.afin', true, 'opera'],
            ['com.startpage.mobile', true, 'startpage-private-search-engine'],
            ['ace.avd.tube.video.downloader', true, 'free-video-downloader-pro'],
            ['com.catdaddy.cat22', true, 'wwe-supercard'],
            ['com.jlwf.droid.tutu', true, 'tutu-app'],
            ['com.tct.launcher', true, 'joy-launcher'],
            ['com.baidu.searchbox', true, 'baidu box app'],
            ['de.eue.mobile.android.mail', true, 'einsundeins-mail'],
            ['com.wfeng.droid.tutu', true, 'tutu-app'],
            ['com.honor.global', true, 'honor-store'],
            ['com.finimize.oban', true, 'finimize'],
            ['com.myhomescreen.weather', true, 'weather-home'],
            ['hot.fiery.browser', true, 'fiery-browser'],
            ['de.gmx.mobile.android.mail', true, 'gmx-mail'],
            ['de.twokit.castbrowser', true, 'tv-cast'],
            ['de.twokit.castbrowser.pro', true, 'tv-cast-pro'],
            ['com.esaba.downloader', true, 'downloader'],
            ['com.agilebits.onepassword', true, '1password'],
            ['com.browser2345_ucc', true, '2345 browser'],
            ['com.browser2345hd', true, '2345-browser-hd'],
            ['air.stage.web.view', true, 'adobe air'],
            ['air.stagewebview', true, 'adobe air'],
            ['air.StageWebViewBridgeTest.debug', true, 'adobe air'],
            ['air.StageWebViewVideo.debug', true, 'adobe air'],
            ['com.adobe.phonegap.app', true, 'adobe-phonegap'],
            ['com.adobe.reader', true, 'adobe-reader'],
        ];
    }
}
