...
final class XRequestedWithTest extends TestCase
{
    ...
    public static function providerUa(): array
    {
        return [
            ...
            ['castify.roku', true, 'cast-web-videos', true, null],
            ['za.co.tracker.consumer', true, 'tracker-connect', true, null],
            ['nu.bi.moya', true, 'moyaapp', true, null],
            ['com.tradron.hdvideodownloader', true, 'download-hub', true, null],
            ['com.box.video.downloader', true, 'box-video-downloader', true, null],
            ['com.sec.android.app.sbrowser', true, 'samsungbrowser', true, null],
            ['com.opera.mini.native.beta', true, 'opera mini beta', true, null],
            ['com.yandex.browser', true, 'yabrowser', true, null],
            ['org.mozilla.firefox', true, 'firefox', true, null],
            ['com.tv.browser.open', true, 'open-tv-browser', true, null],
            ['com.logicui.tvbrowser2', true, 'logicui-tv-browser', true, null],
            ['com.internet.tvbrowser', true, 'browser-app-browser', true, null],
            ['com.sweep.cleaner.trash.junk', true, 'sweep-cleaner', true, null],
            ['com.flatfish.cal.privacy', true, 'hidex-calculator-photo-vault', true, null],
            ['com.myhomescreen.news', true, 'news-home', true, null],
            ['com.myhomescreen.fitness', true, 'fit-home', true, null],
            ['com.fsecure.ms.talktalksa', true, 'talktalk-supersafe', true, null],
            ['com.fsecure.ms.actshield', true, 'act-shield', true, null],
            ['com.fsecure.ms.kpn.veilig', true, 'veilig-virusscanner', true, null],
            ['com.twitter.android', true, 'twitter app', true, null],
            ['com.seraphic.openinet.pre', true, 'metax-open-browser', true, null],
            ['org.telegram.messenger.web', true, 'telegram-app', true, null],
            ['com.android.media.module.services', true, 'mediaservices-apk', true, null],
            ['mojeek.app', true, 'mojeek-app', true, null],
            ['com.castify', true, 'cast-to-tv-plus', true, null],
            ['com.stickypassword.android', true, 'sticky-password', true, null],
            ['com.qihoo.security', true, '360-security', true, null],
            ['com.nytimes.crossword', true, 'nytimes-crossword', true, null],
            ['com.aospstudio.tvsearch', true, 'neptune-tv-browser', true, null],
            ['com.playit.videoplayer', true, 'play-it', true, null],
            ['com.repotools.whatplay', true, 'what-play', true, null],
            ['com.instabridge.android', true, 'insta-bridge', true, null],
            ['com.antivirus.master.cmsecurity', true, 'cm-security', true, null],
            ['com.nocardteam.nocardvpn.lite', true, 'no-card-lite', true, null],
            ['com.nocardteam.nocardvpn', true, 'no-card', true, null],
            ['com.ezt.vpn', true, 'ez-vpn', true, null],
            ['net.daum.android.daum', true, 'daum-app', true, null],
            ['com.fsecure.ms.sonera', true, 'telia-turvapaketti', true, null],
            ['com.fsecure.ms.sfr', true, 'sfr-securite', true, null],
            ['com.fsecure.ms.upc.ch', true, 'upc-internet-security', true, null],
            ['com.fsecure.ms.dnafi', true, 'dna-digiturva', true, null],
            ['com.nate.android.portalmini', true, 'nate-app', true, null],
            ['com.bigqsys.photosearch.searchbyimage2020', true, 'photo-search-app', true, null],
            ['com.qjy.browser', true, 'qjy-tv-browser', true, null],
            ['com.myhomescreen.messenger.home.emoji.lite', true, 'messenger-lite', true, null],
            ['com.myhomescreen.access', true, 'big-keyboard', true, null],
            ['com.myhomescreen.email', true, 'email-home', true, null],
            ['com.myhomescreen.sms', true, 'messenger-home', true, null],
            ['io.bluewallet.bluewallet', true, 'blue-wallet', true, null],
            ['com.bifrostwallet.app', true, 'bifrost-wallet', true, null],
            ['com.tt.android.dm.view', true, 'download-manager', true, null],
            ['com.wukongtv.wkcast.intl', true, 'quick-cast-app', true, null],
            ['mobi.deallauncher.coupons.shopping', true, 'coupons-promo-codes', true, null],
            ['idm.video.free', true, 'idm-video-download-manager', true, null],
            ['de.twokit.video.tv.cast.browser.samsung', true, 'tv-cast', true, null],
            ['de.twokit.video.tv.cast.browser.lg', true, 'tv-cast', true, null],
            ['de.twokit.video.tv.cast.browser.firetv', true, 'tv-cast', true, null],
            ['de.twokit.castbrowsernexusplayer', true, 'tv-cast', true, null],
            ['com.tuya.smartlife', true, 'smart-life', true, null],
            ['com.waze', true, 'waze-navigation', true, null],
            ['com.transsion.hilauncher', true, 'hios-launcher', true, null],
            ['com.opera.app.news', true, 'opera news', true, null],
            ['com.reddit.frontpage', true, 'reddit-app', true, null],
            ['com.harshad.someto', true, 'social-media-explorer', true, null],
            ['com.tcl.live', true, 'tcl-live', true, null],
            ['com.thinkfree.searchbyimage', true, 'reverse-image-search', true, null],
