...
final class Detector8Test extends TestCase
{
     ...
     */
    public function testGetBrowserWithoutCacheButWithPlatformCode17(): void
    {
        $hash                    = 'test-hash';
        $headerValue             = 'abc';
        ...
        $exception = new UnexpectedValueException('invalid version');
        ...
        $version
            ...
            ->method('getVersion')
            ->willReturnCallback(
                static function (int $mode) use ($matcher, $completePlatformVersion, $exception): string {
