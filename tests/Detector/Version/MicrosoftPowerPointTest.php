 ...
 */
class MicrosoftPowerPointTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var MicrosoftPowerPoint
     */
    private $object;
    ...
    {
        $this->object = new MicrosoftPowerPoint('Test-User-Agent');
    }
    ...
    /**
     * @covers BrowserDetector\Detector\Version\MicrosoftPowerPoint::detectVersion
