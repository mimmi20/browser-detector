 ...
 */
class Standard2 extends \PHPUnit_Framework_TestCase {
    /**
    ...
    public function testAttributesAsStringAccepted()
    {
        ...
        $this->assertSame(
            array('multiple' => 'multiple', 'style' => 'height: 2em;', 'class' => 'foo', 'width' => '100%'), 
            $obj->getAttributes()
        );
    }
    ...
    public function testNonXhtmlAttributesTransformed()
    {
        ...
        $this->assertSame(
            array('multiple' => 'multiple', 'selected' => 'selected', 'checked' => 'checked', 'nowrap' => 'nowrap'),
            $obj->getAttributes()
        );
    }
