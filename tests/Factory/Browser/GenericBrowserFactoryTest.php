...
use BrowserDetector\Factory\Browser\GenericBrowserFactory;
 ...
 */
class GenericBrowserFactoryTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \BrowserDetector\Factory\Browser\GenericBrowserFactory
     */
    private $object;
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new GenericBrowserFactory($loader);
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/browser/generic-browser.json'), true);
    }
}
