...
class MobistelFactoryTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new MobistelFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/mobistel.json'), true);
    }
}
