...
class SupraFactoryTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new SupraFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/supra.json'), true);
    }
}
