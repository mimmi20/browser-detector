...
class BqFactoryTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new BqFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/bq.json'), true);
    }
}
