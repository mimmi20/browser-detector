...
class HtcFactoryTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new HtcFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/htc.json'), true);
    }
}
