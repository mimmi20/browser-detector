 ...
 */
class HuaweiFactoryTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new HuaweiFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/huawei.json'), true);
    }
}
