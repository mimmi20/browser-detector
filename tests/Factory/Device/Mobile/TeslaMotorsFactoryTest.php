...
use BrowserDetector\Factory\Device\Mobile\TeslaMotorsFactory;
use BrowserDetector\Loader\DeviceLoader;
use BrowserDetectorTest\Factory\DeviceTestDetectTrait;
use Psr\Log\NullLogger;
use Symfony\Component\Cache\Simple\FilesystemCache;

class TeslaMotorsFactoryTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \BrowserDetector\Factory\Device\Mobile\TeslaMotorsFactory
     */
    private $object;
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new TeslaMotorsFactory($loader);
    }
