...
class TmobileFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function providerDetect()
    {
        return [
            ...
            [
                'Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 8.12; MSIEMobile 6.0) PPC; MDA_Vario_V/1.1 Profile/MIDP-2.0 Configuration/CLDC-1.1',
                'MDA Vario V',
                'MDA Vario V',
                'HTC',
                'T-Mobile',
            ...
            [
                'Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 7.11) PPC; 640x480; Ameo 16GB/1.1 Profile/MIDP-2.0 Configuration/CLDC-1.1',
                'Ameo',
                'Ameo',
                'T-Mobile',
                'T-Mobile',
