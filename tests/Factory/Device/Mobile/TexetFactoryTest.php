...
class TexetFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->object = new TexetFactory($loader);
    }
    ...
    public function providerDetect()
    {
        return [
            ...
            [
                'Mozilla/5.0 (Linux; Android 4.2.2; X-pad iX 7 3G(revision 6) Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.114 Safari/537.36',
                'TM-7068',
                'X-pad iX 7 3G',
                'TeXet',
                'TeXet',
            ...
            [
                'Mozilla/5.0 (Linux; Android 4.2.2; teXet X-navi Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 YaBrowser/15.2.2214.3725.00 Mobile Safari/537.36',
                'TM-4672',
                'X-navi',
                'TeXet',
                'TeXet',
            ...
            [
                'Mozilla/5.0 (Linux; Android 4.0.4; TM-3204R Build/IMM76I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.154 YaBrowser/14.4.1750.13427.00 Mobile Safari/537.36',
                'TM-3204R',
                'TM-3204R',
                'TeXet',
                'TeXet',
