...
class VericoFactoryTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new VericoFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/verico.json'), true);
    }
}
