...
class PointOfViewFactoryTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new PointOfViewFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/mobile/pointofview.json'), true);
    }
}
