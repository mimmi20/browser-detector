...
use BrowserDetector\Factory\Device\Tv\ThomsonFactory;
...
{
    /**
     * @var \BrowserDetector\Factory\Device\Tv\ThomsonFactory
     */
    private $object;
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new ThomsonFactory($loader);
    }
    ...
    {
        return json_decode(file_get_contents('tests/data/factory/device/tv/thomson.json'), true);
    }
}
