...
trait DeviceTestDetectTrait
{
     ...
     * @return void
     */
    public function testDetect(string $agent, ?string $deviceName, ?string $marketingName, ?string $manufacturer, ?string $brand, ?string $deviceType, ?bool $dualOrientation, ?string $pointingMethod, ?int $width, ?int $height): void
    {
//        $s = new Stringy($agent);
//
