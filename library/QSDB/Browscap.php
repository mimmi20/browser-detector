...
class QSDB_Browscap
{
     ...
     * @var string
     */
    public $iniFilename     = 'browscap_ini.ini';
     ...
     *
     * @param string $cache_dir the directory where the cache file will be stored
     */
     ...
     *
     * @param string $cache_file the file name
     *
     * @return void
     */
 ...
 * @author    Jonathan Stoppani <st.jonathan@gmail.com>
 * @copyright 2007-2010 Unister GmbH
 * @license   @license   http://www.gnu.org/licenses/lgpl.html GNU Lesser General Public License
 * @link      todo
 */
