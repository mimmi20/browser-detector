...
/**
 * Unister_Finance_Form_Decorator_Row
 *
 * Accepts the options:
 ...
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: Row.php 13 2011-01-06 21:27:04Z tmu $
 */
class Unister_Finance_Form_Decorator_Row extends Zend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $id
     * @return Unister_Finance_Form_Decorator_Row
     */
    ...
    public function __call($method, $args)
    {
        ...
        require_once 'Zend/Form/Exception.php';
        throw new Zend_Form_Exception(sprintf('Invalid method "%s" called in Row decorator', $method));
    }
