...
class DellStreak extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->_utils->checkIfContains($this->_useragent, 'Dell Streak')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/Dell Streak\/([a-zA-Z\d\.]+)/', $this->_useragent, $matches);
