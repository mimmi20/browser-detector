...
class GarminAsusA10 extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->utils->checkIfContains($userAgent, 'Garmin-Asus A10')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/Garmin-Asus A10\/([a-zA-Z\d\.]+)/', $userAgent, $matches);
