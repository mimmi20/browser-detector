...
class OP110 extends DeviceHandler
{
    /**
     * @var string the detected device
     */
    protected $_device = 'OP110';
    ...
    {
        if (!$this->_utils->checkIfContains($this->_useragent, 'OP110')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/OP110\/([a-zA-Z\d\.]+)/', $this->_useragent, $matches);
