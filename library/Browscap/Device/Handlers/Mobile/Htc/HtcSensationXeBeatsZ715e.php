...
class HtcSensationXeBeatsZ715e extends HtcSensationXeBeats
{
     ...
     */
    protected $_device = 'Sensation XE Beats Z715e';
    ...
    public function canHandle()
    {
        ...
        if (!$this->_utils->checkIfContains(array('HTC Sensation XE Beats Z715e', 'HTC_SensationXE_Beats_Z715e', 'HTC Sensation XE with Beats Audio Z715e'))) {
            return false;
        }
