 ...
 * @version    SVN: $Id$
 */
class Olivetti extends GeneralMobile
{
    /**
     * @var string the detected device
     */
    protected $_device = 'general Olivetti Device';

    /**
     * @var string the detected manufacturer
     */
    protected $_manufacturer = 'Olivetti';
    ...
    {
        $chain = new \Browscap\Device\Chain(true, null, __DIR__ . DS . 'Olivetti' . DS, __NAMESPACE__ . '\\Olivetti');
