 ...
 * @version    SVN: $Id$
 */
class BlackBerry9790 extends BlackBerryBase
{
    /**
     * @var string the detected device
     */
    protected $_device = 'BlackBerry 9790';
    ...
    public function canHandle()
    {
        ...
        if (!$this->_utils->checkIfContains(array('BlackBerry 9790', 'BlackBerry9790', 'BlackBerry 9790'))) {
            return false;
        }
    ...
    {
        $browserChain = $this->_utils->getBrowserChainForBlackberry();
