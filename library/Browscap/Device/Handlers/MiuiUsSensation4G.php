...
class MiuiUsSensation4G extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->utils->checkIfContains($userAgent, 'MIUI.us Sensation 4G')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/MIUI.us Sensation 4G\/([a-zA-Z\d\.]+)/', $userAgent, $matches);
