 ...
 * @version    SVN: $Id$
 */
class MacMini extends Macintosh
{
    /**
     * @var string the detected device
     */
    protected $_device = 'Mac Mini';
    ...
    public function canHandle()
    {
        ...
        if ($this->_utils->checkIfContains(array('Macmini'))) {
            return true;
        }
    ...
    {
        $doMatch = preg_match('/Macmini(\d+\.\d+)/', $this->_useragent, $matches);
