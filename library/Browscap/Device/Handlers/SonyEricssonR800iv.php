 ...
 * @version   SVN: $Id: SonyEricssonX10iv.php 173 2012-01-28 13:38:35Z  $
 */
...
class SonyEricssonR800iv extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->utils->checkIfContains($userAgent, 'SonyEricssonR800iv')) {
            return false;
        }
