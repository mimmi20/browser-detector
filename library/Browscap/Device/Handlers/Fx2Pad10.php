...
class Fx2Pad10 extends DeviceHandler
{
    /**
     * @var string the detected device
     */
    protected $_device = 'FX2-PAD10';
    ...
    public function canHandle()
    {
        ...
        if (!$this->_utils->checkIfContains($this->_useragent, 'FX2-PAD10')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/FX2-PAD10\/([a-zA-Z\d\.]+)/', $this->_useragent, $matches);
