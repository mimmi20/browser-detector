...
class HtcIncredibleS extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->utils->checkIfContainsAnyOf($userAgent, array('HTC Incredible S'))) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/HTC\/Incredible\/([a-zA-Z\d\.]+)/', $userAgent, $matches);
