 ...
 * @version   SVN: $Id: HtcHd2.php 173 2012-01-28 13:38:35Z  $
 */
...
class HtcEvo3D extends DeviceHandler
{
    /**
    ...
    {
        if (!$this->utils->checkIfContains($userAgent, 'HTC/EVO_3D')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/HTC\/EVO_3D\/([\d\.]+)/', $userAgent, $matches);
