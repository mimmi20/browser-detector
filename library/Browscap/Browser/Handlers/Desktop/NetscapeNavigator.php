 ...
 * @version    SVN: $Id$
 */
class NetscapeNavigator extends Netscape
{
    /**
     * @var string the detected browser
     */
    protected $_browser = 'Netscape Navigator';
    ...
    public function canHandle()
    {
        ...
        if (!$this->_utils->checkIfContains('Navigator')) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/Navigator\/(\d+\.\d+)/', $this->_useragent, $matches);
