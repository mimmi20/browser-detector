...
class Openwave extends BrowserHandler
{
    ...
    {
        $doMatch = preg_match('/UP\/([\d\.]+)/', $this->_useragent, $matches);
        ...
        $doMatch = preg_match('/UP.Browser\/([\d\.]+)/', $this->_useragent, $matches);
        ...
        $doMatch = preg_match('/OpenWave\/([\d\.]+)/', $this->_useragent, $matches);
