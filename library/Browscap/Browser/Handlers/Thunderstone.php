...
class Thunderstone extends BrowserHandler
{
     ...
     */
    protected $_browser = 'Thunderstone';
    ...
    public function canHandle()
    {
        ...
        if (!$this->_utils->checkIfContainsAnyOf($this->_useragent, array('Thunderstone/'))) {
            return false;
        }
    ...
    {
        $doMatch = preg_match('/Thunderstone\/(\d+\.\d+)/', $this->_useragent, $matches);
