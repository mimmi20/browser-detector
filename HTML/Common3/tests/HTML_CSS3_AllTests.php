 ...
 * @version  CVS: $Id: HTML_CSS3_AllTests.php 11 2010-10-10 19:17:21Z tmu $
 * @link     http://pear.php.net/package/HTML_CSS
 * @since    File available since Release 1.4.0
 */

if (!defined('PHPUnit2_MAIN_METHOD')) {
    define('PHPUnit2_MAIN_METHOD', 'HTML_CSS3_AllTests::main');
}
...
require_once 'HTML_Common3_TestSuite_Standard3.php';
...
class HTML_CSS3_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite('\Test\Standard');
        $suite->addTestSuite('\Test\HTML_CSS3_TestSuite_Standard');
        $suite->addTestSuite('\Test\HTML_CSS3_TestSuite_Output');
        $suite->addTestSuite('\Test\HTML_CSS3_TestSuite_Bugs');
        return $suite;
    }
}

if (PHPUnit2_MAIN_METHOD == 'HTML_CSS3_AllTests::main') {
