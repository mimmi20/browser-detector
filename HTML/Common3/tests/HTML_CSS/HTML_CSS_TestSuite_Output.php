 ...
 * @version  CVS: $Id: HTML_CSS_TestSuite_Output.php 11 2010-10-10 19:17:21Z tmu $
 * @link     http://pear.php.net/package/HTML_CSS
 * @since    File available since Release 1.5.2
 */
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "HTML_CSS_TestSuite_Output::main");
}
...
class HTML_CSS_TestSuite_Output extends PHPUnit_Extensions_OutputTestCase
{
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('HTML_CSS Output Tests');
