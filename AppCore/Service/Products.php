 ...
 * @copyright 2007-2010 Unister GmbH
 */
class Products extends ServiceAbstract
{
    /**
     * Class Constructor
     *
     * @return \AppCore\Service\Products
     */
    public function __construct()
    {
        $this->_model = new \AppCore\Model\Products();
    }
    ...
    {
        return $this->_model->getCached('Products')->check($productId);
    }
    ...
    public function lade($product, &$institut = '', &$sparte = '')
    {
        ...
        $return = $this->_model->getCached('Products')->lade((string) $product);
    ...
    {
        return $this->_model->getCached('Products')->getList(
    ...
    public function getInterface($productId)
    {
        ...
        return $this->_model->getCached('Products')->getInterface($productId);
    }
    ...
    {
        return $this->_model->getCached('Products')->find($productId);
    }
    ...
    {
        return $this->cleanTaggedCache('Products');
    }
}