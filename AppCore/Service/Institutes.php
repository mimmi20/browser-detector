 ...
 * @version   SVN: $Id: Institutes.php -1   $
 */
 ...
 * @copyright 2007-2010 Unister GmbH
 */
class Institutes extends ServiceAbstract
{
    /**
     * Class Constructor
     *
    ...
    {
        $this->_model = new \AppCore\Model\Institutes();
    }
    ...
    {
        return $this->_model->getCached('institute')->getListArray();
    }
    ...
    {
        return $this->_model->getCached('institute')->find($instituteId);
    }
