 ...
 * @version   SVN: $Id: Targo.php 30 2011-01-06 21:58:02Z tmu $
 */
 ...
 * @copyright 2007-2010 Unister GmbH
 */
class Targo extends \Credit\Core\Model\CalcResult
{
    /**
    ...
    {
        //monatliche Rate muss 50 Euro betragen
        if ($this->step && $this->monatlicheRate < 50) {
            return false;
        } else {
            return true;
        }
