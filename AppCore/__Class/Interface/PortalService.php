...
class KreditCore_Class_Interface_PortalService
{
     ...
     * @param \Zend\Db\Table\Row $customer the customer dataset
     *
     * @return KreditCore_Class_Interface_PortalService
     * @throws KreditCore_Class_Exception
     */
    public function __construct($portal, \Zend\Db\Table\Row $customer)
    {
        ...
        if (empty($customer)) {
            throw new KreditCore_Class_Exception(
                'a \Zend\Db\Table\Row object is needed as second ' .
                'parameter'
            );
        }
