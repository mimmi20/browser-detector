 ...
 * @copyright 2007-2010 Unister GmbH
 */
class KreditCore_Class_Credit_Input_Fallback
    extends KreditCore_Class_Credit_Input_Abstract
{
     ...
     *
     * @return KreditCore_Class_Credit_Input_Fallback
     */
    ...
    public function calculate()
    {
        ...
        if (!is_object($campaign)
            || 'Zend_Db_Table_Row' != get_class($campaign)
        ) {
            return array();
        }
     ...
     * @return KreditCore_Class_Credit_Input_Fallback
     */
    private function _fillTables(Zend_Db_Table_Row $campaign,
        Zend_Db_Table_Row $defaultCampaign)
    {
        /*
