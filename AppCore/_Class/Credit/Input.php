 ...
 * @version   SVN: $Id: Input.php 30 2011-01-06 21:58:02Z tmu $
 */
 ...
 * @copyright 2007-2010 Unister GmbH
 */
class KreditCore_Class_Credit_Input
    extends KreditCore_Class_Credit_Input_Abstract
{
    CONST SP = 0;
    CONST FALLBACK = 1;
        ...
        if (!is_object($this->_cache)
            ...
            switch ($this->_mode) {
                case self::SP:
                     ...
                     */
                    $calculator = new KreditCore_Class_Credit_Input_Sp();
                    break;
                case self::FALLBACK:
                    // Break intentionally omitted
                default:
                    //Fallback mode
                    $calculator = new KreditCore_Class_Credit_Input_Fallback();
                    break;
            }
