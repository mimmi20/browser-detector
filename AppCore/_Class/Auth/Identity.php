 ...
 * @version   SVN: $Id: Identity.php 30 2011-01-06 21:58:02Z tmu $
 */
...
class KreditCore_Class_Auth_Identity
{
     ...
     * Class Constructor
     *
     * @param Zend_Db_Table_Row $userRow the user data
     *
     * @return void
     */
    public function __construct(Zend_Db_Table_Row $userRow)
    {
        $this->_row = $userRow;
    }
