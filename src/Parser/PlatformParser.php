...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/windows[ _]nt 10|windows 10|win10/i' => Os::windows10,
            ...
            '/windows nt 6\.1|windows 6\.1|windows 7|cygwin_nt-6\.1|win7/i' => Os::windowsnt61,
            ...
            '/(?<!on microsoft )windows|(?<!dar)win ?(?:10|9|8|7|vista|xp|2000|me|9x|98|95|nt|31|32|16|64)|barca|the bat!|cygwin_(?:nt|9[58]|me)|[\-\( ]mingw32|winhttp|ms-office|microsoft-webdav-miniredir|microsoft bits|microsoft-cryptoapi|microsoft-delivery-optimization|ddg[_-]win/i' => Os::windows,
