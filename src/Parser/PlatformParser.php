...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/ubuntu/i' => Os::ubuntu,
            '/debian/i' => Os::debian,
            '/maemo|(?<!no)tizen|remixos|remix (?:pro|mini)|(?<![0-9a-z])bada|meego|sailfish|chinese operating system|(?<!ma)cos;|\(cos [0-9]|android; cos|wh\/|whaletv|zeasn/i' => Os::maemo,
            '/web0s/i' => Os::lgwebos,
            ...
            '/mobilesafari\/.*cfnetwork|watchos|(?<!like |t)iphone|cpu i?os/i' => Os::ios,
            ...
            '/(networkingextension|com\.apple\.webkit\.networking|safariviewservice|safari technology preview|safarifetcherd)\/[\d\.]+ .* darwin\//i' => Os::macosx,
            ...
            '/haiku/i' => Os::haiku,
            '/beos/i' => Os::horizon,
            '/like mac os x|ip[ao]d|(?<![tx])ios[;\/]|iuc ?\(|puffin\/[\d\.]+i[pt]|antenna\/|antennapod|rss_?radio|podcruncher|audioboom|stitcher\/ios|captivenetwork|ios\.watch/i' => Os::ios,
