...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/(?<!on microsoft )windows|win ?(?:10|9|8|7|vista|xp|2000|me|9x|98|95|nt|31|32|16|64)|barca|the bat!|cygwin_(?:nt|9[58]|me)|[\-\( ]mingw32|winhttp|ms-office/i' => Os::windows,
            ...
            '/andr0id|android tv|g[o0][o0]gle tv|smarttv 4k/i' => Os::androidtv,
            ...
            '/mobilesafari\/.*cfnetwork|watchos|(?<!like |t)iphone|cpu i?os|like mac os x|(?<![a-z])ios[;\/\.\-]/i' => Os::ios,
            '/mac os x|os\=mac 10|mac ?os\//i' => Os::macosx,
            '/morphos/i' => Os::morphos,
            '/mac_powerpc|ppc|68k/i' => Os::macintosh,
            '/safari\/.*cfnetwork|power macintosh|nook browser/i' => Os::macosx,
            ...
            '/haiku/i' => Os::haiku,
            '/beos/i' => Os::beos,
            '/ip[ao]d|(?<![a-z])ios \d|iuc ?\(|puffin\/[\d\.]+i[pt]|antenna\/|antennapod|rss_?radio|podcruncher|audioboom|stitcher\/ios|captivenetwork|ios\.watch/i' => Os::ios,
