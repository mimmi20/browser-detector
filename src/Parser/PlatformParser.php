...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/series ?30|nokia 2660 flip/i' => Os::series30,
            '/symb(?:ian|os)|nokia7230/i' => Os::symbianOs,
            '/netbsd/i' => Os::netbsd,
            ...
            '/Lineage_(\d+[.\d]*)|(?:Android (\d([\d.])*);? )?(?:lineage_\w+|Switch(?: Lite| OLED)?\))/i' => Os::lineageos,
