...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/mobilesafari\/.*cfnetwork|watchos|(?<!like |t)iphone|cpu i?os|like mac os x|(?<![atx])ios[;\/\.\-]/i' => Os::ios,
            ...
            '/haiku/i' => Os::haiku,
            '/beos/i' => Os::beos,
            '/ip[ao]d|(?<![atx])ios \d|iuc ?\(|puffin\/[\d\.]+i[pt]|antenna\/|antennapod|rss_?radio|podcruncher|audioboom|stitcher\/ios|captivenetwork|ios\.watch/i' => Os::ios,
