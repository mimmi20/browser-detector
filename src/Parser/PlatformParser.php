...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/windows phone(?: os)? (10|[678])\.[015]|windows 10 mobile/i' => Os::windowsphone,
            ...
            '/windows nt 6\.1|windows 6\.1|windows 7|cygwin_nt-6\.1|(?<!dar)win7(?![0-9])/i' => Os::windowsnt61,
            '/windows nt 6\.0|windows 6\.0|windows vista|nt 6\.0/i' => Os::windowsnt60,
            ...
            '/(?<!on microsoft |pia)windows|(?<!dar)win ?(?:10|9|8|7|vista|xp|2000|me|9x|98|95|nt|31|32|16|64)|barca|the bat!|cygwin_(?:nt|9[58]|me)|[\-\( ]mingw32|winhttp|ms-office|microsoft-webdav-miniredir|microsoft bits|microsoft-cryptoapi|microsoft-delivery-optimization|ddg[_-]win/i' => Os::windows,
            ...
            '/(?<!o)andr[0o]id|silk|juc ?\(linux;|adr |gingerbread|ucweb\/2\.0 \(linux;|vre;|beyondpod|htc_sensation_z710e|puffin\/[\d\.]+a[tp]|okhttp|fban\/fb4a.*fbsv\/|ddg[_-]android/i' => Os::android,
