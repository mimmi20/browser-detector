...
final readonly class PlatformParser implements PlatformParserInterface
{
    ...
    public function parse(string $useragent): OsInterface
    {
        $regexes = [
            ...
            '/(?<!on microsoft )windows|win ?(?:10|9|8|7|vista|xp|2000|me|9x|98|95|nt|31|32|16|64)|barca|the bat!|cygwin_(?:nt|9[58]|me)|[\-\( ]mingw32|winhttp|ms-office|microsoft-webdav-miniredir|microsoft bits|microsoft-cryptoapi|microsoft-delivery-optimization/i' => Os::windows,
            ...
            '/(?<!o)andr[0o]id|silk|juc ?\(linux;|adr |gingerbread|ucweb\/2\.0 \(linux;|vre;|beyondpod|htc_sensation_z710e|puffin\/[\d\.]+a[tp]|okhttp|fban\/fb4a.*fbsv\//i' => Os::android,
