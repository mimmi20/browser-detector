...
final class MobileParser implements DeviceParserInterface
{
    private $factories = [
        ...
        '/sharp|shl2[25]|shv3[15]|is05|[0-9]{3}sh|sh-?[0-9]{2,4}[cdefuw]|fs8010/i' => 'sharp',
        '/flytouch/i' => 'flytouch',
        ...
        '/(hw-)?(huawei|ideos|honor[ _]?)|(ags2?|ale|ane|atu|aum|bah2?|bkl|bl[an]|bnd|btv|cam|chc|che[12]|ch(e2?|m)|chm|clt|cmr|col|crr|dig|dli|dra|eml|eva|fdr|fig|frd|g621|h[36]0|(?<!eng)ine|jsn|kiw|ldn|lld|lya|mha|ne[mo]| pe|pic|(?<!ap)pl[ek]|pra|rne|scl|sla|sne|stf|t1|trt|vie|vky|vtr|was|y220)-|u(8100|8110|8230|8500|8661|8665|8667|8800|8818|8860|9200|9508)[);\/ ]|bucare y330-u05|hi6210sft|vodafone[ _]858|vodafone 845|ascend|m860| p6 |enjoy 7 plus|g6600|p7mini|p8_max|t1-701u|t1 7\.0/i' => 'huawei',
        ...
        '/lenovo|smart ?tab|idea(tab|pad)|thinkpad|yoga tablet|(?<!mi) [ak]1 (?!lite)|a1_07| a6[05] |at1010-t|b5032|b5060|b5531|e1041x|e10[56]0x|k910l|p1060x|(adr|android) [67].* p2|p770|s1032x|s6000d|tab2a7-|x1030x|yb1-x90l|zuk | k6( build|[;\/\)])|a238t|z2131|tb-x704[av]/i' => 'lenovo',
        '/fujitsu|m532|m305|f-0[0-9][def]|is11t|fartm933kz/i' => 'fujitsu',
        '/pentagram|monster x5|quadra 7 ultraslim/i' => 'pentagram',
        '/quadro/i' => 'quadro',
        '/akai|glory[ _](o2|l3|g5)|eco e2|tab-7800|tab-7830|tab-9800q?|x6 metal|aktb-703mz/i' => 'akai',
        '/iris708/i' => 'ais',
        ...
        '/alcatel|alc[a-z0-9]+|one[ _]?touch|idol3| (a571vl|a464bg|9203a|9022x|9010x|9008[adijntux]|9007[atx]|9005x|9003[ax]|9001[ix]|8050[degx]|8030y|8020d|8008d|8000d|7070x|7055a|7049d|7048[aswx]|7047d|7044[ax]|7043[aeky]|7041[dx]|7040[adefknrt]|7025d|6070[koy]|6062w|6058[adx]|6055[abdhikuyz]|6050[afy]|6045[bfioy]|6043[ad]|6040d|6039[ahky]|6037[bky]|6036[axy]|6035r|6034[mry]|6033x|6032|6030[dx]|6016[adex]|6015x|6012[adew]|6010[dx]|5145a|5116j|5099[adiuy]|5098[os]|5095[biky]|5090[aiy]|5086[ady]|5085[abdghijnoqy]|5080[adfqux]|5070[dx]|5065[adjtwx]|5059[adijtxy]|5058[aijty]|5057m|5056[adegijmntuw]|5054[adnstx]|5052[d]|5051[aejmtwx]|5050[sy]|5049[egswz]|5047[diuy]|5046[adgijstuy]|5045[adfgijy]|5044[adgikopsty]|5042[adefgwx]|5038[aex]|5036[dx]|5035[dexy]|5027b|5026[ad]|5025[degnx]|5023[ef]|5022[dex]|5020[adew]|5017[bdeox]|5016[aj]|5015[adex]|5012[dfg]|5011a|5010[degsu]|5009[ad]|4114e|4060s|4049[degmx]|4047[adfgnx]|4045[adex]|4037t|4035[adxy]|4034[adegx]|4033[de]|4032[aex]|4030[adxy]|4028[aejs]|4027[adn]|4024[dex]|4019a|4018[adefmx]|4017[adefsx]|4016[adx]|4015[adntx]|4014[adekmx]|4013[dejkm]|4012[ax]|4010[ad]|4009[adefikmsx]|4007[dx]|4003j|3075a|fl02|i213|i216x|v860|vodafone (smart|785|875|975n)|vf-(795|895n)|m812c|telekom puls|ot-[89][09][0-9]|a462c)[);\/ ]/i' => 'alcatel',
        '/toshiba/i' => 'toshiba',
        ...
        '/eSTAR/' => 'estar',
        '/NTT/' => 'nttsystem',
        '/iq1055|iq1010/i' => 'mls', // must be before Fly
        ...
        '/ (b15q?|s[346]1|s[46]0)( build|[;\/\)])/i' => 'caterpillar',
        ...
        '/w960|netbox| x10 | e1[05]i| x2 |r800x|s500i|x1i|x10i|[ls]39h|h3113|h3213|h3311|h4113|h4311|h8166|h8216|h8266|h8314|h8324|h9436|ebrd[0-9]{4}|502so|sol22|sov3[23]/i' => 'sony',
        '/x1013|coto w418/i' => 'top-house',
        '/haier| w[0-9]{3}[ )]|h[mtw]-[ginvw][0-9]{1,3}| l52 | g55 | g3[01]s? |pad g781|pad971|pad d71/i' => 'haier',
        ...
        '/leagoo|lead [12]|t1_plus|elite [45]|shark 1|s8_pro|m8 pro|kiicaa (power|mix)/i' => 'leagoo',
        ...
        '/N[0-9]{4}/' => 'star',
        '/medipad/i' => 'bewatec',
        '/nexus|google ?tv|glass|crkey[^a-z0-9]|google pixel|pixel( build|[;\)])|pixel (xl|c|2|2 xl)( build|[;\/\)])|gce x86 phone|android sdk/i' => 'google',
