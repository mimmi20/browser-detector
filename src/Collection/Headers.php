            ...
            switch ($firstPlatformCode) {
                ...
                case \BrowserDetector\Data\Os::windows:
                    ...
                    if (
                        ...
                        && in_array(
                            $lastPlatformCode,
                            [\BrowserDetector\Data\Os::windows10, \BrowserDetector\Data\Os::windowsnt62, \BrowserDetector\Data\Os::windowsnt61, \BrowserDetector\Data\Os::windowsnt, \BrowserDetector\Data\Os::ios],
                            true,
                        )
                    ) {
                        $platform       = $lastPlatformCode;
