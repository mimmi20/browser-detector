...
final readonly class Safari implements VersionFactoryInterface
{
    ...
    public function detectVersion(string $useragent): VersionInterface
    {
        $regexes = [
            ...
            '/(Safari|com\.apple\.WebKit\.Networking|NetworkingExtension|Safari Technology Preview|safarifetcherd|com\.apple\.AuthenticationServicesCore\.AuthenticationServicesAgent)\/(?P<version>[\d\.]+)/',
        ];
