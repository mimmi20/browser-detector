...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/oppo|x90[0-9]{1,2}|n52[0-9]{2}|r[12678][0-9]{2,3}|u70[0-9]t|f1f|find7|a3[37]f|r7[ks]?f|r7plus[fm]| 1201 | 1107 |n1t|cph160[79]|cph1701|cph1717|cph1723|(adr|android) 4\.2.* n1|padm00/i' => 'oppo',
