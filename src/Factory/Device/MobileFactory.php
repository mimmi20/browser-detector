...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/lenovo|smart ?tab|idea(tab|pad)|thinkpad|yoga tablet|(?<!mi) [ak]1 |a1_07| a6[05] |at1010\-t|b5060|b5531|e1041x|e10[56]0x|k910l|p1060x|(adr|android) [67].* p2|p770|s1032x|s6000d|tab2a7\-|x1030x|yb1\-x90l|zuk | k6 build/i' => 'lenovo',
