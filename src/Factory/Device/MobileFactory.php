...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/gionee/i' => 'gionee',
        '/videocon/i' => 'videocon',
        '/gigaset|gs55\-6|gs53\-6|gs370_plus/i' => 'gigaset',
        ...
        '/BARRY|BIRDY|BLOOM|CINK|FEVER|FIZZ|GETAWAY| GOA|HIGHWAY|IGGY|JIMMY|JERRY|KITE|OZZY|PLUS|PULP|RIDGE|ROBBY|SLIDE|STAIRWAY|SUBLIM|SUNNY|SUNSET|U FEEL|WAX/' => 'wiko',
        '/l5510|lenny|rainbow|view xl|view prime|w_k400/i' => 'wiko',
