...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/uniscope/i' => 'uniscope',
        '/lg(?!e)|lge(?! nexus)|g3mini|vs[0-9]{3}| g3 |p713|p509|c660 |(?<!s)(ls|vm|ln|us)[0-9]{3}|optimus g|l-0[0-9][cde]|lm-(g710|x410\.fn|x210)/i' => 'lg',
        '/sprint/i' => 'sprint',
        '/videocon/i' => 'videocon',
