...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/tolino/i' => 'tolino',
        '/odys|xelio_next|(maven|space|tao|thor)_?x?10|connect(7pro|8plus)|loox|uno_x10|xelio|neo_quad10|ieos_quad|sky plus|maven_10_plus|maven10_hd_plus_3g|maven_x10_hd_lte|space10_plus|adm816|noon|xpress|genesis|tablet-pc-4|kinder-tablet|evolution12|mira|score_plus|pro q8 plus|rapid7lte|neo6_lte|rapid_10|visio(?!n)|pace10|falcon_10_plus_3g/i' => 'odys',
        ...
        '/lenovo|smart ?tab|idea(tab|pad)|thinkpad|yoga tablet|(?<!mi) [ak]1 |a1_07| a6[05] |at1010\-t|b5060|b5531|e1041x|e1050x|k910l|p1060x|(adr|android) [67].* p2|p770|s1032x|s6000d|tab2a7\-|x1030x|yb1\-x90l|zuk /i' => 'lenovo',
        ...
        '/oppo|x90[0-9]{1,2}|n52[0-9]{2}|r[12678][0-9]{2,3}|u70[0-9]t|f1f|find7|a3[37]f|r7[ks]?f|r7plus[fm]| 1201 | 1107 |n1t|a160[13]|cph160[79]|cph1701|cph1717|cph172[37]|cph1819|cph1859|(adr|android) 4\.2.* n1|padm00|rmx1805/i' => 'oppo',
