...
class MobileFactory implements DeviceFactoryInterface
{
    private $factories = [
        ...
        '/ARK/' => 'ark',
        '/Magic/' => 'magic',
        '/M[Ii][ -](?:\d|PAD|M[AI]X|NOTE|A1)/' => 'xiaomi',
        ...
        '/CINK PEAX 2|JERRY|BLOOM|SLIDE|GETAWAY|WAX|KITE|BARRY|HIGHWAY|OZZY|RIDGE|PULP|SUNNY|FEVER|PLUS|SUNSET|FIZZ|U FEEL|CINK SLIM|ROBBY/' => 'wiko',
