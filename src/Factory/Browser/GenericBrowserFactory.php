...
class GenericBrowserFactory implements FactoryInterface
{
    private $browsers = [
        ...
        '/UP\//'                                                                          => 'openwave mobile browser',
        '/(obigointernetbrowser|obigo\-browser|obigo|telecabrowser|teleca)(\/|-)q(\d+)/i' => 'obigo q',
        'teleca'                                                                          => 'teleca-obigo',
        'obigo'                                                                           => 'teleca-obigo',
        'au-mic'                                                                          => 'teleca-obigo',
        'mic/'                                                                            => 'teleca-obigo',
        ...
        '/go ([\d\.]+) package http/i'                                                    => 'go httpclient',
        '/nf[34]/i'                                                                       => 'netfront',
     ...
     * @var string
     */
    private $genericBrowser = 'unknown';
