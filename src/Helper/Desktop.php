...
final class Desktop implements DesktopInterface
{
    ...
    public function isDesktopDevice(string $useragent): bool
    {
        ...
        if (
            preg_match(
                '/macintosh|darwin|mac(_powerpc|book|mini|pro)|(for|ppc) mac|mac ?os|integrity|camino|pubsub|(os\=|i|power)mac|syllable|red hat modified|fedora|morphos|dragonfly|gentoo|charon|odyssey web browser|\(pc;/i',
                $useragent,
            )
        ) {
            return true;
