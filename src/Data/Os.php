...
enum Os: string implements OsInterface
{
    ...
    {
        return match ($this) {
            self::android, self::chromeos, self::fuchsia, self::wearos, self::androidtv, self::googleTv, self::androidGo => 'google',
            self::asha, self::nokiaos, self::series30, self::series40, self::series60 => 'nokia',
            self::tvos, self::audioos, self::ios, self::macosx, self::darwin, self::macintosh, self::watchos => 'apple',
            self::bada, self::orsay => 'samsung',
            self::cellos, self::orbisos, self::newsos => 'sony',
            self::fireos, self::vegaOS => 'amazon',
            self::firefoxos => 'mozilla',
            self::miuios, self::hyperOS => 'xiaomi',
            self::lgwebos => 'lg',
            self::windows, self::windows2003, self::windows31, self::windows311, self::windows95, self::windows98, self::windowsce, self::windowsiot, self::windowsme, self::windowsmobileos, self::windowsnt, self::windows10, self::windows11, self::windowsnt31, self::windowsnt35, self::windowsnt351, self::windowsnt40, self::windowsnt41, self::windowsnt410, self::windowsnt50, self::windowsnt501, self::windowsnt51, self::windowsnt52, self::windowsnt53, self::windowsnt60, self::windowsnt61, self::windowsnt62, self::windowsnt63, self::windowsnt64, self::windowsphone, self::windowsphone10, self::windowsphone65, self::windowsphone75, self::windowsphone80, self::windowsphone81, self::windowsrt62, self::windowsrt63, self::azurelinux, self::kinos => 'microsoft',
            self::yi => 'baidu',
            self::harmonyos, self::harmonyosNext => 'huawei',
            self::aix, self::os2 => 'ibm',
            self::beos => 'access',
            self::bsd => 'berkeley',
            self::dangeros => 'danger',
            self::debian, self::debianWithFreeBSDKernel, self::raspbian => 'softwareInThePublicInterest',
            self::fedoraLinux, self::redhatLinux => 'redhat',
            self::freebsd => 'freebsd',
            self::gentooLinux => 'gentoo',
            self::haiku => 'haiku',
            self::hpux, self::openvms, self::tru64unix, self::webos => 'hp',
            self::infernoOs => 'vitanuova',
            ...
            self::mre => 'mediatek',
            self::nintendoOs, self::nintendoSwitchOs, self::nintendoWiiOs => 'nintendo',
            self::nucleus => 'acceleratedTechnology',
            self::opensolaris, self::solaris, self::sunos => 'oracle',
            self::palmOs => 'palm',
            self::remixOs => 'jide',
            self::rimOs, self::rimTabletOs => 'rim',
            self::sailfishOs => 'jolla',
            self::slackwareLinux => 'slackware',
            self::startos => 'ylmf',
            self::suseLinux, self::openSuse => 'suse',
            self::syllable => 'syllable',
            self::symbianOs => 'symbianFoundation',
            self::ventanaLinux => 'ventana',
            self::yunOs => 'alibaba',
            self::leafOs => 'nComputing',
            self::puffinOs => 'cloudMosa',
            self::viziOs => 'vizio',
            self::ultrix => 'dec',
            self::osf1 => 'osf',
            self::lindows, self::linspire => 'linspire',
            self::openHarmony => 'openatomFoundation',
            self::plasmaMobile => 'kde',
            self::whaleOS => 'whaleTV',
            self::operaTv => 'opera',
            self::smartisanOS => 'smartisan',
            self::horizon => 'meta',
            self::qtopia => 'trolltech',
            self::pureOS => 'purism',
            self::fritzOS => 'fritz',
            self::rokuOS => 'roku',
            self::vidaaOS => 'vidaa',
            ...
            self::qnx => 'blackberry',
            self::picoOS => 'pico',
            self::routerOS => 'mikrotik',
            self::nuttX => 'apache',
            self::minix => 'andrewStuartTanenbaum',
            self::plan9 => 'plan9Foundation',
            self::deepin => 'deepinTechnology',
            self::thinOS => 'dell',
            self::fydeOS => 'fyde',
            self::myOS => 'zte',
            self::fortiOS => 'fortinet',
            default => null,
        };
    }
    ...
    public function getVersion(): array
    {
        return match ($this) {
            ...
            self::openHarmony => ['factory' => VersionBuilderFactory::class, 'search' => ['OpenHarmony-', 'OpenHarmony']],
            ...
            self::fortiOS => ['factory' => VersionBuilderFactory::class, 'search' => ['FortiOS']],
